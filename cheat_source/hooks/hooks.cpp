...
namespace hooks
{
	...
	void GUI_Init(IDirect3DDevice9* pDevice)
	{
		...
		auto verdana_directory = (std::string)windows_directory + "\\Fonts\\System.ttf"; // Verdana.ttf
		...
		c_menu::get().mainesp = io.Fonts->AddFontFromMemoryTTF((void*)mainesp, sizeof(mainesp), 20.f, &m_config, ranges);
