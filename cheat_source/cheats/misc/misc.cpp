...
#if RELEASE
#if BETA
#define VERSION crypt_str("Zerus [beta] | ")
#else
#define VERSION crypt_str("Zerus | ")
#endif
#else
#define VERSION crypt_str("Wasovski - ")
#endif
...
void misc::watermark()
{
	...
	render::get().gradient(width - 10 - box_width, 10, box_width / 2, 1, Color(g_cfg.menu.watercolor1.r(), g_cfg.menu.watercolor1.g(), g_cfg.menu.watercolor1.b(), 255), Color(g_cfg.menu.watercolor2.r(), g_cfg.menu.watercolor2.g(), g_cfg.menu.watercolor2.b(), 255), GRADIENT_HORIZONTAL);
	render::get().gradient(width - 10 - box_width + (box_width / 2), 10, box_width / 2, 1, Color(g_cfg.menu.watercolor2.r(), g_cfg.menu.watercolor2.g(), g_cfg.menu.watercolor2.b(), 255), Color(g_cfg.menu.watercolor1.r(), g_cfg.menu.watercolor1.g(), g_cfg.menu.watercolor1.b(), 255), GRADIENT_HORIZONTAL);
...
void misc::ChatSpamer()
{
	...
	{ 
		crypt_str("Wasovski.git"),
		crypt_str("Ultra Wasovski"),
		crypt_str("Feel Monster Academy"),
		crypt_str("Mega Wasovski"),
	};
...
bool misc::double_tap(CUserCmd* m_pcmd)
{
	...
	{
		auto recharge_time = g_ctx.globals.weapon->can_double_tap() ? TIME_TO_TICKS(0.5f) : TIME_TO_TICKS(0.9f);
