...
void lagcompensation::update_player_animations(player_t* e)
{
...
#endif
	{
		...
		if (&g_cfg.ragebot.lowdelta_resolver)
		{
			switch (record->side)
			{
			case RESOLVER_1:
			...
			case RESOLVER_2:
				...
				break;
			case RESOLVER_3:
				record->side = RESOLVER_LOW_3;
				break;
			case RESOLVER_4:
				record->side = RESOLVER_LOW_4;
				break;
			case RESOLVER_5:
				record->side = RESOLVER_LOW_5;
				break;
			case RESOLVER_6:
				record->side = RESOLVER_LOW_6;
				break;
			case RESOLVER_7:
				record->side = RESOLVER_LOW_7;
				break;
			case RESOLVER_8:
				record->side = RESOLVER_LOW_8;
				break;
			case RESOLVER_9:
				record->side = RESOLVER_LOW_9;
				break;
			case RESOLVER_10:
				record->side = RESOLVER_LOW_10;
				break;
			case RESOLVER_11:
				record->side = RESOLVER_LOW_11;
				break;
			case RESOLVER_12:
				record->side = RESOLVER_LOW_12;
				break;
			case RESOLVER_13:
				record->side = RESOLVER_LOW_13;
				break;
			case RESOLVER_14:
				record->side = RESOLVER_LOW_14;
				break;
			case RESOLVER_LOW_FIRST:
				record->side = RESOLVER_1;
				break;
			case RESOLVER_LOW_SECOND:
				record->side = RESOLVER_2;
				break;
			case RESOLVER_LOW_3:
				record->side = RESOLVER_3;
				break;
			case RESOLVER_LOW_4:
				record->side = RESOLVER_4;
				break;
			case RESOLVER_LOW_5:
				record->side = RESOLVER_5;
				break;
			case RESOLVER_LOW_6:
				record->side = RESOLVER_6;
				break;
			case RESOLVER_LOW_7:
				record->side = RESOLVER_7;
				break;
			case RESOLVER_LOW_8:
				record->side = RESOLVER_8;
				break;
			case RESOLVER_LOW_9:
				record->side = RESOLVER_9;
				break;
			case RESOLVER_LOW_10:
				record->side = RESOLVER_10;
				break;
			case RESOLVER_LOW_11:
				record->side = RESOLVER_11;
				break;
			case RESOLVER_LOW_12:
				record->side = RESOLVER_12;
				break;
			case RESOLVER_LOW_13:
				record->side = RESOLVER_13;
				break;
			case RESOLVER_LOW_14:
				record->side = RESOLVER_14;
				break;
			}
		}
		...
		case RESOLVER_2:
			...
			break;
		case RESOLVER_3:
			animstate->m_flGoalFeetYaw = math::normalize_yaw(e->m_angEyeAngles().y + 45.0f);
			break;
		case RESOLVER_4:
			animstate->m_flGoalFeetYaw = math::normalize_yaw(e->m_angEyeAngles().y - 45.0f);
			break;
		case RESOLVER_5:
			animstate->m_flGoalFeetYaw = math::normalize_yaw(e->m_angEyeAngles().y + 35.0f);
			break;
		case RESOLVER_6:
			animstate->m_flGoalFeetYaw = math::normalize_yaw(e->m_angEyeAngles().y - 35.0f);
			break;
		...
		case RESOLVER_10:
			...
			break;
		case RESOLVER_11:
			animstate->m_flGoalFeetYaw = math::normalize_yaw(e->m_angEyeAngles().y + 18.0f);
			break;
		case RESOLVER_12:
			animstate->m_flGoalFeetYaw = math::normalize_yaw(e->m_angEyeAngles().y - 18.0f);
			break;
		case RESOLVER_13:
			animstate->m_flGoalFeetYaw = math::normalize_yaw(e->m_angEyeAngles().y + 15.0f);
			break;
		case RESOLVER_14:
			animstate->m_flGoalFeetYaw = math::normalize_yaw(e->m_angEyeAngles().y - 15.0f);
			break;
		...
		case RESOLVER_LOW_SECOND:
			...
			break;
		case RESOLVER_LOW_3:
			animstate->m_flGoalFeetYaw = math::normalize_yaw(e->m_angEyeAngles().y + 25.0f);
			break;
		case RESOLVER_LOW_4:
			animstate->m_flGoalFeetYaw = math::normalize_yaw(e->m_angEyeAngles().y - 25.0f);
			break;
		case RESOLVER_LOW_5:
			animstate->m_flGoalFeetYaw = math::normalize_yaw(e->m_angEyeAngles().y + 23.0f);
			break;
		case RESOLVER_LOW_6:
			animstate->m_flGoalFeetYaw = math::normalize_yaw(e->m_angEyeAngles().y - 23.0f);
			break;
		...
		case RESOLVER_LOW_10:
			...
			break;
		case RESOLVER_LOW_11:
			animstate->m_flGoalFeetYaw = math::normalize_yaw(e->m_angEyeAngles().y + 19.5f);
			break;
		case RESOLVER_LOW_12:
			animstate->m_flGoalFeetYaw = math::normalize_yaw(e->m_angEyeAngles().y - 19.5f);
			break;
		case RESOLVER_LOW_13:
			animstate->m_flGoalFeetYaw = math::normalize_yaw(e->m_angEyeAngles().y + 15.5f);
			break;
		case RESOLVER_LOW_14:
			animstate->m_flGoalFeetYaw = math::normalize_yaw(e->m_angEyeAngles().y - 15.5f);
			break;
